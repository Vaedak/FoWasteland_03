...
public class Modeldynamite<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "dynamite"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition dynamite = partdefinition
				.addOrReplaceChild("dynamite",
						CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 7.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 23.0F, 0.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition cube_r1 = dynamite
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(9, 0).addBox(-1.0F, -5.0F, 0.0F, 5.0F, 7.0F, 0.0F,
								new CubeDeformation(0.0F)),
