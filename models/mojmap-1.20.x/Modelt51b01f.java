...
public class Modelt51b01f<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "t51b01f"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head_r1 = Head.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(0, 27).addBox(-4.5F, -4.0F, -3.5F, 9.0F, 8.0F, 7.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition Body_r2 = Body.addOrReplaceChild("Body_r2",
				CubeListBuilder.create().texOffs(0, 54).addBox(-4.0F, -4.0F, -3.5F, 8.0F, 8.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition RightArm_r1 = RightArm.addOrReplaceChild("RightArm_r1",
				CubeListBuilder.create().texOffs(0, 67).addBox(-2.5F, -3.0F, -3.0F, 5.0F, 6.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = LeftArm.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(62, 47)
						.addBox(-5.0F, -4.0F, -4.0F, 7.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(66, 17)
		...
		PartDefinition cube_r5 = LeftArm
				.addOrReplaceChild("cube_r5",
						CubeListBuilder.create().texOffs(0, 42).addBox(-5.0F, -4.0F, -4.0F, 7.0F, 4.0F, 8.0F,
								new CubeDeformation(0.1F)),
						PartPose.offsetAndRotation(5.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.0873F));
