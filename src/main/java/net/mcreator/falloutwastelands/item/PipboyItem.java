...
import net.mcreator.falloutwastelands.procedures.PipboySetBASETPProcedure;
import net.mcreator.falloutwastelands.item.inventory.PipboyInventoryCapability;
...
public class PipboyItem extends Item {
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Pip-Boy 2500");
				}
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		PipboySetBASETPProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getPlayer(), context.getItemInHand());
