...
import net.mcreator.falloutwastelands.procedures.NailGunShootProcedure;
...
public class NailgunItem extends Item {
	...
	public boolean onEntitySwing(ItemStack itemstack, LivingEntity entity) {
		...
		NailGunShootProcedure.execute(entity.level(), entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
		return retval;
	}
