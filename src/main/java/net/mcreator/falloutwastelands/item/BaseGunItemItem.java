...
public class BaseGunItemItem extends Item {
	public BaseGunItemItem() {
		super(new Item.Properties().durability(13).rarity(Rarity.COMMON));
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		if (CanUseRangedItemProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, ar.getObject()))
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entity, int time) {
		if (!world.isClientSide() && entity instanceof ServerPlayer player) {
			...
			if (player.getAbilities().instabuild || stack != ItemStack.EMPTY) {
				BaseGunItemProjectileEntity projectile = BaseGunItemProjectileEntity.shoot(world, entity, world.getRandom());
				...
				WhenRangedItemIsUsedProcedure.execute(world, entity, itemstack);
			}
		}
	}

	private ItemStack findAmmo(Player player) {
		return new ItemStack(BaseGunItemProjectileEntity.PROJECTILE_ITEM.getItem());
	}
}
