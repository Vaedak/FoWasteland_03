...
public class FriendlyTurretBulletRenderer extends EntityRenderer<FriendlyTurretBulletEntity> {
	...
	public FriendlyTurretBulletRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelgunshot(context.bakeLayer(Modelgunshot.LAYER_LOCATION));
	}

	@Override
	public void render(FriendlyTurretBulletEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(FriendlyTurretBulletEntity entity) {
		return texture;
	}
}
