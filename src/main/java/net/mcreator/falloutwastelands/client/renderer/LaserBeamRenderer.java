...
public class LaserBeamRenderer extends EntityRenderer<LaserBeamEntity> {
	private static final ResourceLocation texture = new ResourceLocation("fallout_wastelands_:textures/entities/laserriflebeam.png");
	private final Modellaserriflebeam model;

	public LaserBeamRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modellaserriflebeam(context.bakeLayer(Modellaserriflebeam.LAYER_LOCATION));
	}
