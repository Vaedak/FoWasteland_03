...
import net.mcreator.falloutwastelands.procedures.ShouldDisplayTPButtonProcedure;
import net.mcreator.falloutwastelands.network.PipboyGUIButtonMessage;
...
public class PipboyGUIScreen extends AbstractContainerScreen<PipboyGUIMenu> {
	...
	public void init() {
		...
		button_teleport_to_base = Button.builder(Component.translatable("gui.fallout_wastelands_.pipboy_gui.button_teleport_to_base"), e -> {
			if (ShouldDisplayTPButtonProcedure.execute(entity)) {
			...
			public void renderWidget(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
				this.visible = ShouldDisplayTPButtonProcedure.execute(entity);
