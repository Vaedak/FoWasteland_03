...
import net.mcreator.falloutwastelands.procedures.DisplayRecruitButtonProcedure;
import net.mcreator.falloutwastelands.network.SettlerControllerButtonMessage;
...
public class SettlerControllerScreen extends AbstractContainerScreen<SettlerControllerMenu> {
	...
	public void init() {
		...
		button_recruit = Button.builder(Component.translatable("gui.fallout_wastelands_.settler_controller.button_recruit"), e -> {
			if (DisplayRecruitButtonProcedure.execute()) {
			...
			public void renderWidget(GuiGraphics guiGraphics, int gx, int gy, float ticks) {
				this.visible = DisplayRecruitButtonProcedure.execute();
