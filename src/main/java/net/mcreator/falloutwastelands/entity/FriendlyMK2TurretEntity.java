...
public class FriendlyMK2TurretEntity extends PathfinderMob {

	public FriendlyMK2TurretEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FalloutWastelandsModEntities.FRIENDLY_MK_2_TURRET.get(), world);
	}

	public FriendlyMK2TurretEntity(EntityType<FriendlyMK2TurretEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
