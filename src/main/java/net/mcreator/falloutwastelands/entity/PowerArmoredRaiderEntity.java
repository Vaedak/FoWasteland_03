...
public class PowerArmoredRaiderEntity extends Monster implements RangedAttackMob {
	public PowerArmoredRaiderEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FalloutWastelandsModEntities.POWER_ARMORED_RAIDER.get(), world);
	}

	public PowerArmoredRaiderEntity(EntityType<PowerArmoredRaiderEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 1;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(FalloutWastelandsModItems.INDUSTRIALHAMMER.get()));
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(FalloutWastelandsModItems.RAIDER_PA_HELMET.get()));
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(FalloutWastelandsModItems.RAIDER_PA_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(FalloutWastelandsModItems.RAIDER_PA_LEGGINGS.get()));
		this.setItemSlot(EquipmentSlot.FEET, new ItemStack(FalloutWastelandsModItems.RAIDER_PA_BOOTS.get()));
	}
