...
import net.mcreator.falloutwastelands.procedures.FriendlyTurretBulletWhileProjectileFlyingTickProcedure;
import net.mcreator.falloutwastelands.procedures.FriendlyTurretBulletProjectileHitsLivingEntityProcedure;
...
public class FriendlyTurretBulletEntity extends AbstractArrow implements ItemSupplier {
	...
	public void tick() {
		super.tick();
		FriendlyTurretBulletWhileProjectileFlyingTickProcedure.execute(this);
		if (this.inGround)
			this.discard();
	}
