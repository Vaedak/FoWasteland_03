...
public class SpiderfloaterEntity extends Monster implements RangedAttackMob, GeoEntity {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, Cannibal00Entity.class, true, true));
		this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, Cannibal01Entity.class, true, true));
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, BrahminEntity.class, true, true));
		this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, BlastmasterRaiderEntity.class, true, true));
		this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, GeckoEntity.class, true, true));
		this.targetSelector.addGoal(8, new NearestAttackableTargetGoal(this, LobotomiteWalkerEntity.class, true, true));
		this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, Wolf.class, true, true));
		this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, RaiderscavangerEntity.class, true, true));
		this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, RaiderDustwalkerEntity.class, true, true));
		this.targetSelector.addGoal(12, new NearestAttackableTargetGoal(this, Animal.class, true, true));
		...
		this.goalSelector.addGoal(1, new SpiderfloaterEntity.RangedAttackGoal(this, 1.25, 20, 10f) {
			@Override
	...
	public class RangedAttackGoal extends Goal {
		...
		public void stop() {
			...
			this.seeTime = 0;
			this.attackTime = -1;
			((SpiderfloaterEntity) rangedAttackMob).entityData.set(SHOOT, false);
		}
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((SpiderfloaterEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		SpiderfloaterEntityProjectile entityarrow = new SpiderfloaterEntityProjectile(FalloutWastelandsModEntities.SPIDERFLOATER_PROJECTILE.get(), this, this.level());
