...
import net.mcreator.falloutwastelands.procedures.PowerArmorFrameTickUpdateProcedure;
import net.mcreator.falloutwastelands.procedures.PowerArmorFrameRightClickedProcedure;
import net.mcreator.falloutwastelands.procedures.FrameInitialSpawnProcedure;
