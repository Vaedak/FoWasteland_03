...
public class RadroachEntity extends Monster implements GeoEntity {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(16, new NearestAttackableTargetGoal(this, FeralGhoulEntity.class, false, false));
		this.targetSelector.addGoal(17, new NearestAttackableTargetGoal(this, RadscorpionEntity.class, false, false));
	...
	public static void init() {
		SpawnPlacements.register(FalloutWastelandsModEntities.RADROACH.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
