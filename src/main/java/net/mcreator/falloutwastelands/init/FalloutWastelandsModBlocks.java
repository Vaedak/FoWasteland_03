...
import net.mcreator.falloutwastelands.block.YielroadsignBlock;
...
import net.mcreator.falloutwastelands.block.VaultTile6Block;
...
import net.mcreator.falloutwastelands.block.VaultGridBlockBlock;
...
import net.mcreator.falloutwastelands.block.VaultBarRightBlock;
import net.mcreator.falloutwastelands.block.VaultBarLeftBlock;
...
import net.mcreator.falloutwastelands.block.SandbagstairsBlock;
import net.mcreator.falloutwastelands.block.SandbagsSlabBlock;
import net.mcreator.falloutwastelands.block.SandbagsBlock;
...
import net.mcreator.falloutwastelands.block.MetalBoxBlock;
...
import net.mcreator.falloutwastelands.block.LaboratoryfloorTileBlock;
import net.mcreator.falloutwastelands.block.LaboratorycomputerblockBlock;
import net.mcreator.falloutwastelands.block.LaboratoryTileBlock;
import net.mcreator.falloutwastelands.block.LaboratoryTile7Block;
import net.mcreator.falloutwastelands.block.LaboratoryTile6Block;
import net.mcreator.falloutwastelands.block.LaboratoryTile5Block;
import net.mcreator.falloutwastelands.block.LaboratoryTile4Block;
import net.mcreator.falloutwastelands.block.LaboratoryTile3Block;
import net.mcreator.falloutwastelands.block.LaboratoryTile2Block;
import net.mcreator.falloutwastelands.block.LaboratoryBigTileBlock;
import net.mcreator.falloutwastelands.block.LaboratoryBarLeftBlock;
import net.mcreator.falloutwastelands.block.JoshueaTreeStairsBlock;
import net.mcreator.falloutwastelands.block.JoshuaTreeWoodplanksBlock;
...
import net.mcreator.falloutwastelands.block.FacilitywallexposedBlock;
import net.mcreator.falloutwastelands.block.FacilityventBlock;
import net.mcreator.falloutwastelands.block.FacilitypressureplateBlock;
import net.mcreator.falloutwastelands.block.FacilitypillarBlock;
import net.mcreator.falloutwastelands.block.FacilityfloorBlock;
import net.mcreator.falloutwastelands.block.FacilityWallYellowBlock;
import net.mcreator.falloutwastelands.block.FacilityWallCurvedBlock;
import net.mcreator.falloutwastelands.block.FacilityWallBlock;
import net.mcreator.falloutwastelands.block.FacilityTile6Block;
import net.mcreator.falloutwastelands.block.FacilityTile5Block;
import net.mcreator.falloutwastelands.block.FacilityTile4Block;
import net.mcreator.falloutwastelands.block.FacilityTile3Block;
import net.mcreator.falloutwastelands.block.FacilityTile2Block;
import net.mcreator.falloutwastelands.block.FacilityTile1Block;
import net.mcreator.falloutwastelands.block.FacilityReinforcedPillarBlock;
import net.mcreator.falloutwastelands.block.FacilityGridStairsBlock;
import net.mcreator.falloutwastelands.block.FacilityGridSlabBlock;
import net.mcreator.falloutwastelands.block.FacilityGridBlockBlock;
import net.mcreator.falloutwastelands.block.FacilityButtonBlock;
import net.mcreator.falloutwastelands.block.FacilityBarLeftBlock;
...
import net.mcreator.falloutwastelands.block.EnclaveBunkerpressureplateBlock;
...
import net.mcreator.falloutwastelands.block.EnclaveBunkerFloorSlabBlock;
...
import net.mcreator.falloutwastelands.block.EnclaveBunkerButtonBlock;
...
import net.mcreator.falloutwastelands.block.BlueindustrialdoorBlock;
import net.mcreator.falloutwastelands.block.BlueIndustrialWalkwayBlock;
import net.mcreator.falloutwastelands.block.BlueIndustrialAlloytoprivetBlock;
import net.mcreator.falloutwastelands.block.BlueIndustrialAlloymiddlerivetBlock;
import net.mcreator.falloutwastelands.block.BlueIndustrialAlloymiddlecutBlock;
import net.mcreator.falloutwastelands.block.BlueIndustrialAlloylowerrivetBlock;
import net.mcreator.falloutwastelands.block.BlueIndustrialAlloyWalkwayStairsBlock;
import net.mcreator.falloutwastelands.block.BlueIndustrialAlloyWalkwaySlabBlock;
import net.mcreator.falloutwastelands.block.BlueIndustrialAlloyTopRivetStairsBlock;
import net.mcreator.falloutwastelands.block.BlueIndustrialAlloyTopRivetSlabBlock;
import net.mcreator.falloutwastelands.block.BlueIndustrialAlloyStairsBlock;
import net.mcreator.falloutwastelands.block.BlueIndustrialAlloySlabBlock;
import net.mcreator.falloutwastelands.block.BlueIndustrialAlloySignBlock;
import net.mcreator.falloutwastelands.block.BlueIndustrialAlloyBlock;
...
import net.mcreator.falloutwastelands.block.BaseWallBlock;
...
public class FalloutWastelandsModBlocks {
	...
	public static final RegistryObject<Block> JOSHUA_TREE_WOODPLANKS = REGISTRY.register("joshua_tree_woodplanks", () -> new JoshuaTreeWoodplanksBlock());
	public static final RegistryObject<Block> JOSHUEA_TREE_STAIRS = REGISTRY.register("joshuea_tree_stairs", () -> new JoshueaTreeStairsBlock());
	public static final RegistryObject<Block> JOSHUA_TREE_SLAB = REGISTRY.register("joshua_tree_slab", () -> new JoshuaTreeSlabBlock());
	public static final RegistryObject<Block> JOSHUA_TREE_DOOR = REGISTRY.register("joshua_tree_door", () -> new JoshuaTreeDoorBlock());
	public static final RegistryObject<Block> JOSHUA_TREE_DOORTRAP = REGISTRY.register("joshua_tree_doortrap", () -> new JoshuaTreeDoortrapBlock());
	public static final RegistryObject<Block> STOPROADSIGN = REGISTRY.register("stoproadsign", () -> new StoproadsignBlock());
	public static final RegistryObject<Block> YIELROADSIGN = REGISTRY.register("yielroadsign", () -> new YielroadsignBlock());
	...
	public static final RegistryObject<Block> BLUE_INDUSTRIAL_ALLOY = REGISTRY.register("blue_industrial_alloy", () -> new BlueIndustrialAlloyBlock());
	public static final RegistryObject<Block> BLUE_INDUSTRIAL_ALLOY_SIGN = REGISTRY.register("blue_industrial_alloy_sign", () -> new BlueIndustrialAlloySignBlock());
	public static final RegistryObject<Block> BLUE_INDUSTRIAL_ALLOYTOPRIVET = REGISTRY.register("blue_industrial_alloytoprivet", () -> new BlueIndustrialAlloytoprivetBlock());
	public static final RegistryObject<Block> BLUE_INDUSTRIAL_ALLOYMIDDLERIVET = REGISTRY.register("blue_industrial_alloymiddlerivet", () -> new BlueIndustrialAlloymiddlerivetBlock());
	public static final RegistryObject<Block> BLUE_INDUSTRIAL_ALLOYLOWERRIVET = REGISTRY.register("blue_industrial_alloylowerrivet", () -> new BlueIndustrialAlloylowerrivetBlock());
	public static final RegistryObject<Block> BLUE_INDUSTRIAL_ALLOYMIDDLECUT = REGISTRY.register("blue_industrial_alloymiddlecut", () -> new BlueIndustrialAlloymiddlecutBlock());
	public static final RegistryObject<Block> BLUEINDUSTRIALDOOR = REGISTRY.register("blueindustrialdoor", () -> new BlueindustrialdoorBlock());
	public static final RegistryObject<Block> BLUE_INDUSTRIAL_WALKWAY = REGISTRY.register("blue_industrial_walkway", () -> new BlueIndustrialWalkwayBlock());
	public static final RegistryObject<Block> BLUE_INDUSTRIAL_ALLOY_STAIRS = REGISTRY.register("blue_industrial_alloy_stairs", () -> new BlueIndustrialAlloyStairsBlock());
	public static final RegistryObject<Block> BLUE_INDUSTRIAL_ALLOY_SLAB = REGISTRY.register("blue_industrial_alloy_slab", () -> new BlueIndustrialAlloySlabBlock());
	public static final RegistryObject<Block> BLUE_INDUSTRIAL_ALLOY_TOP_RIVET_STAIRS = REGISTRY.register("blue_industrial_alloy_top_rivet_stairs", () -> new BlueIndustrialAlloyTopRivetStairsBlock());
	public static final RegistryObject<Block> BLUE_INDUSTRIAL_ALLOY_TOP_RIVET_SLAB = REGISTRY.register("blue_industrial_alloy_top_rivet_slab", () -> new BlueIndustrialAlloyTopRivetSlabBlock());
	public static final RegistryObject<Block> BLUE_INDUSTRIAL_ALLOY_WALKWAY_STAIRS = REGISTRY.register("blue_industrial_alloy_walkway_stairs", () -> new BlueIndustrialAlloyWalkwayStairsBlock());
	public static final RegistryObject<Block> BLUE_INDUSTRIAL_ALLOY_WALKWAY_SLAB = REGISTRY.register("blue_industrial_alloy_walkway_slab", () -> new BlueIndustrialAlloyWalkwaySlabBlock());
	public static final RegistryObject<Block> ENCLAVE_BUNKERPRESSUREPLATE = REGISTRY.register("enclave_bunkerpressureplate", () -> new EnclaveBunkerpressureplateBlock());
	public static final RegistryObject<Block> ENCLAVE_BUNKER_BUTTON = REGISTRY.register("enclave_bunker_button", () -> new EnclaveBunkerButtonBlock());
	public static final RegistryObject<Block> ENCLAVE_BUNKER_FLOOR_SLAB = REGISTRY.register("enclave_bunker_floor_slab", () -> new EnclaveBunkerFloorSlabBlock());
	public static final RegistryObject<Block> ENCLAVE_BUNKER_BLOCK_SLAB = REGISTRY.register("enclave_bunker_block_slab", () -> new EnclaveBunkerBlockSlabBlock());
	public static final RegistryObject<Block> BASE_WALL = REGISTRY.register("base_wall", () -> new BaseWallBlock());
	public static final RegistryObject<Block> VAULT_GRID_BLOCK = REGISTRY.register("vault_grid_block", () -> new VaultGridBlockBlock());
	public static final RegistryObject<Block> FACILITY_WALL = REGISTRY.register("facility_wall", () -> new FacilityWallBlock());
	public static final RegistryObject<Block> FACILITY_REINFORCED_PILLAR = REGISTRY.register("facility_reinforced_pillar", () -> new FacilityReinforcedPillarBlock());
	public static final RegistryObject<Block> FACILITY_GRID_BLOCK = REGISTRY.register("facility_grid_block", () -> new FacilityGridBlockBlock());
	public static final RegistryObject<Block> FACILITY_WALL_YELLOW = REGISTRY.register("facility_wall_yellow", () -> new FacilityWallYellowBlock());
	public static final RegistryObject<Block> FACILITY_WALL_CURVED = REGISTRY.register("facility_wall_curved", () -> new FacilityWallCurvedBlock());
	public static final RegistryObject<Block> FACILITYWALLEXPOSED = REGISTRY.register("facilitywallexposed", () -> new FacilitywallexposedBlock());
	public static final RegistryObject<Block> FACILITYFLOOR = REGISTRY.register("facilityfloor", () -> new FacilityfloorBlock());
	public static final RegistryObject<Block> FACILITYPILLAR = REGISTRY.register("facilitypillar", () -> new FacilitypillarBlock());
	public static final RegistryObject<Block> FACILITYVENT = REGISTRY.register("facilityvent", () -> new FacilityventBlock());
	public static final RegistryObject<Block> FACILITY_TILE_1 = REGISTRY.register("facility_tile_1", () -> new FacilityTile1Block());
	public static final RegistryObject<Block> FACILITY_TILE_2 = REGISTRY.register("facility_tile_2", () -> new FacilityTile2Block());
	public static final RegistryObject<Block> FACILITY_TILE_3 = REGISTRY.register("facility_tile_3", () -> new FacilityTile3Block());
	public static final RegistryObject<Block> FACILITY_TILE_4 = REGISTRY.register("facility_tile_4", () -> new FacilityTile4Block());
	public static final RegistryObject<Block> FACILITY_TILE_5 = REGISTRY.register("facility_tile_5", () -> new FacilityTile5Block());
	public static final RegistryObject<Block> FACILITY_BAR_LEFT = REGISTRY.register("facility_bar_left", () -> new FacilityBarLeftBlock());
	public static final RegistryObject<Block> VAULT_BAR_LEFT = REGISTRY.register("vault_bar_left", () -> new VaultBarLeftBlock());
	public static final RegistryObject<Block> VAULT_BAR_RIGHT = REGISTRY.register("vault_bar_right", () -> new VaultBarRightBlock());
	public static final RegistryObject<Block> FACILITY_BUTTON = REGISTRY.register("facility_button", () -> new FacilityButtonBlock());
	public static final RegistryObject<Block> FACILITYPRESSUREPLATE = REGISTRY.register("facilitypressureplate", () -> new FacilitypressureplateBlock());
	public static final RegistryObject<Block> VAULT_TILE_6 = REGISTRY.register("vault_tile_6", () -> new VaultTile6Block());
	public static final RegistryObject<Block> FACILITY_TILE_6 = REGISTRY.register("facility_tile_6", () -> new FacilityTile6Block());
	public static final RegistryObject<Block> LABORATORY_TILE = REGISTRY.register("laboratory_tile", () -> new LaboratoryTileBlock());
	public static final RegistryObject<Block> LABORATORY_TILE_2 = REGISTRY.register("laboratory_tile_2", () -> new LaboratoryTile2Block());
	public static final RegistryObject<Block> LABORATORY_TILE_3 = REGISTRY.register("laboratory_tile_3", () -> new LaboratoryTile3Block());
	public static final RegistryObject<Block> LABORATORY_TILE_4 = REGISTRY.register("laboratory_tile_4", () -> new LaboratoryTile4Block());
	public static final RegistryObject<Block> LABORATORY_TILE_5 = REGISTRY.register("laboratory_tile_5", () -> new LaboratoryTile5Block());
	public static final RegistryObject<Block> LABORATORY_TILE_6 = REGISTRY.register("laboratory_tile_6", () -> new LaboratoryTile6Block());
	public static final RegistryObject<Block> LABORATORY_TILE_7 = REGISTRY.register("laboratory_tile_7", () -> new LaboratoryTile7Block());
	public static final RegistryObject<Block> LABORATORYFLOOR_TILE = REGISTRY.register("laboratoryfloor_tile", () -> new LaboratoryfloorTileBlock());
	public static final RegistryObject<Block> LABORATORY_BIG_TILE = REGISTRY.register("laboratory_big_tile", () -> new LaboratoryBigTileBlock());
	public static final RegistryObject<Block> LABORATORY_BAR_LEFT = REGISTRY.register("laboratory_bar_left", () -> new LaboratoryBarLeftBlock());
