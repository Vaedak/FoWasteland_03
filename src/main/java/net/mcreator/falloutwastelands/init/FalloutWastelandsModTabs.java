...
public class FalloutWastelandsModTabs {
	...
	public static final RegistryObject<CreativeModeTab> WASTELAND_NATURALS = REGISTRY.register("wasteland_naturals",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.fallout_wastelands_.wasteland_naturals")).icon(() -> new ItemStack(FalloutWastelandsModBlocks.WASTELAND_DIRT.get())).displayItems((parameters, tabData) -> {
	...
	public static final RegistryObject<CreativeModeTab> WASTELANDBLOCKSTAB = REGISTRY.register("wastelandblockstab",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.fallout_wastelands_.wastelandblockstab")).icon(() -> new ItemStack(FalloutWastelandsModBlocks.CAGE.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(FalloutWastelandsModBlocks.BLUE_INDUSTRIAL_ALLOY.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BLUE_INDUSTRIAL_ALLOY_SIGN.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BLUE_INDUSTRIAL_ALLOYTOPRIVET.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BLUE_INDUSTRIAL_ALLOYMIDDLERIVET.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BLUE_INDUSTRIAL_ALLOYLOWERRIVET.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BLUE_INDUSTRIAL_ALLOYMIDDLECUT.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BLUEINDUSTRIALDOOR.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BLUE_INDUSTRIAL_WALKWAY.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BLUE_INDUSTRIAL_ALLOY_STAIRS.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BLUE_INDUSTRIAL_ALLOY_SLAB.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BLUE_INDUSTRIAL_ALLOY_TOP_RIVET_STAIRS.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BLUE_INDUSTRIAL_ALLOY_TOP_RIVET_SLAB.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BLUE_INDUSTRIAL_ALLOY_WALKWAY_STAIRS.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BLUE_INDUSTRIAL_ALLOY_WALKWAY_SLAB.get().asItem());
				...
				tabData.accept(FalloutWastelandsModBlocks.VAULT_TILE_1.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.VAULT_TILE_2.get().asItem());
				...
				tabData.accept(FalloutWastelandsModBlocks.ENCLAVE_BUNKERPRESSUREPLATE.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.ENCLAVE_BUNKER_BUTTON.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.ENCLAVE_BUNKER_FLOOR_SLAB.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.ENCLAVE_BUNKER_BLOCK_SLAB.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.BASE_WALL.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.VAULT_GRID_BLOCK.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.FACILITY_WALL.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.FACILITY_REINFORCED_PILLAR.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.FACILITY_GRID_BLOCK.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.FACILITY_WALL_YELLOW.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.FACILITY_WALL_CURVED.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.FACILITYWALLEXPOSED.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.FACILITYFLOOR.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.FACILITYPILLAR.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.FACILITYVENT.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.FACILITY_TILE_1.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.FACILITY_TILE_2.get().asItem());
				tabData.accept(FalloutWastelandsModBlocks.FACILITY_TILE_3.get().asItem());
	...
	public static final RegistryObject<CreativeModeTab> WASTELANDCOMBAT = REGISTRY.register("wastelandcombat",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.fallout_wastelands_.wastelandcombat")).icon(() -> new ItemStack(FalloutWastelandsModItems.RAIDERBLASTMASTER_HELMET.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(FalloutWastelandsModItems.RAIDER_PA_HELMET.get());
				tabData.accept(FalloutWastelandsModItems.RAIDER_PA_CHESTPLATE.get());
				tabData.accept(FalloutWastelandsModItems.RAIDER_PA_LEGGINGS.get());
				tabData.accept(FalloutWastelandsModItems.RAIDER_PA_BOOTS.get());
	...
	public static final RegistryObject<CreativeModeTab> WASTELANDITEMS = REGISTRY.register("wastelanditems",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.fallout_wastelands_.wastelanditems")).icon(() -> new ItemStack(FalloutWastelandsModItems.JERRICAN.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(FalloutWastelandsModItems.RED_PAINT_CAN.get());
				tabData.accept(FalloutWastelandsModItems.GREEN_PAINT_CAN.get());
				tabData.accept(FalloutWastelandsModItems.BLACK_PAINT_CAN.get());
				tabData.accept(FalloutWastelandsModItems.BLUE_PAINT_CAN.get());
				tabData.accept(FalloutWastelandsModItems.WHITE_PAINT_CAN.get());
				tabData.accept(FalloutWastelandsModItems.GREY_PAINT_CAN.get());
				tabData.accept(FalloutWastelandsModItems.EMPTY_PAINT_CAN.get());
			})
