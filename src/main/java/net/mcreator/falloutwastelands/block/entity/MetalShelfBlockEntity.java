...
public class MetalShelfBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(28, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public MetalShelfBlockEntity(BlockPos position, BlockState state) {
		super(FalloutWastelandsModBlockEntities.METAL_SHELF.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("metal_shelf");
	}
