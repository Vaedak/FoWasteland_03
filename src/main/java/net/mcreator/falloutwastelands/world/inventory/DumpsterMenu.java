...
public class DumpsterMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DumpsterMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FalloutWastelandsModMenus.DUMPSTER.get(), id);
