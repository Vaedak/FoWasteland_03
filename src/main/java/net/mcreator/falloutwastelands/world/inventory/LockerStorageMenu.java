...
import net.mcreator.falloutwastelands.procedures.LockerGUIopenedProcedure;
import net.mcreator.falloutwastelands.procedures.LockerGUIcloseProcedure;
...
public class LockerStorageMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LockerStorageMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FalloutWastelandsModMenus.LOCKER_STORAGE.get(), id);
		...
		this.customSlots.put(21, this.addSlot(new SlotItemHandler(internal, 21, 25, 70) {
			private final int slot = 21;
		}));
		this.customSlots.put(22, this.addSlot(new SlotItemHandler(internal, 22, 43, 70) {
			private final int slot = 22;
		}));
		this.customSlots.put(23, this.addSlot(new SlotItemHandler(internal, 23, 61, 70) {
			private final int slot = 23;
		}));
		this.customSlots.put(24, this.addSlot(new SlotItemHandler(internal, 24, 79, 70) {
			private final int slot = 24;
		}));
		this.customSlots.put(25, this.addSlot(new SlotItemHandler(internal, 25, 97, 70) {
			private final int slot = 25;
		}));
		this.customSlots.put(26, this.addSlot(new SlotItemHandler(internal, 26, 115, 70) {
