...
public class WastelandCityTrunkDecorator extends TrunkVineDecorator {
	public static Codec<WastelandCityTrunkDecorator> CODEC = Codec.unit(WastelandCityTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("wasteland_city_tree_trunk_decorator", DECORATOR_TYPE));
	}
