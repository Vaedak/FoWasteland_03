...
public class WastelandMountainsTrunkDecorator extends TrunkVineDecorator {
	public static Codec<WastelandMountainsTrunkDecorator> CODEC = Codec.unit(WastelandMountainsTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("wasteland_mountains_tree_trunk_decorator", DECORATOR_TYPE));
	}
