...
public class WastelandMountainsLeaveDecorator extends LeaveVineDecorator {

	public static Codec<LeaveVineDecorator> CODEC = Codec.unit(WastelandMountainsLeaveDecorator::new);

	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("wasteland_mountains_tree_leave_decorator", DECORATOR_TYPE));
	}

	public WastelandMountainsLeaveDecorator() {
		super(0.25f);
	}
