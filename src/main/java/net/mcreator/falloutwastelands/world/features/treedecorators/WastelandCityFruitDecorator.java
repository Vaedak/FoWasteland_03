...
public class WastelandCityFruitDecorator extends CocoaDecorator {
	public static Codec<WastelandCityFruitDecorator> CODEC = Codec.unit(WastelandCityFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("wasteland_city_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public WastelandCityFruitDecorator() {
		super(0.2f);
	}
