...
public class DecrimentDefenseProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if ((entity.getPersistentData().getString("assignedBASE")).equals((new Object() {
			...
			}.getAmount(world, BlockPos.containing(entity.getPersistentData().getDouble("basePosX"), entity.getPersistentData().getDouble("basePosY"), entity.getPersistentData().getDouble("basePosZ")), 198) > 0) {
				{
					...
					if (_ent != null) {
						...
						final ItemStack _setstack = new ItemStack(FalloutWastelandsModItems.DEFENSE_ICON.get()).copy();
						...
						}.getAmount(world, BlockPos.containing(entity.getPersistentData().getDouble("basePosX"), entity.getPersistentData().getDouble("basePosY"), entity.getPersistentData().getDouble("basePosZ")), 198) - 1));
